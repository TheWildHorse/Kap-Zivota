...
public class CanIDonate extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (etWeight.length() <= 0) {
            Toast.makeText(CanIDonate.this, CanIDonate.this.getResources().getString(R.string.cidWrongData), Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (ok) {
            ...
            builder.setMessage(CanIDonate.this.getResources().getString(R.string.cidMess1) ).setPositiveButton(CanIDonate.this.getResources().getString(R.string.cidExit), dialogClickListener).setNegativeButton(CanIDonate.this.getResources().getString(R.string.cidDon), dialogClickListener).show();
        } else {
            DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage(CanIDonate.this.getResources().getString(R.string.cidMess2) ).setNegativeButton(CanIDonate.this.getResources().getString(R.string.cidExit), dialogClickListener).show();
        }
