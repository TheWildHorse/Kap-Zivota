    ...
    public void onClick(View v) {
        ...
        if (matcher.matches()) {
            if (p1.equals(p2) && p1.length() > 3) {
                ...
                Toast.makeText(Registration.this, "Provjeri password", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(Registration.this, "EMAIL adresa neispravna", Toast.LENGTH_LONG).show();
        }
    }
...
// Create a new HttpClient and Post Header
        ...
        protected void onPostExecute(String data) {
            ...
            if (ok) {
                ...
                Toast.makeText(Registration.this, "REGISTRACIJA NEUSPJELA", Toast.LENGTH_LONG).show();
            }
        }
    }
