...
{{ Form::model($institution, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('institutions.update', $institution->id))) }}
        ...
        <div class="row">
            <div class="col-md-6">
            {{ Form::input('hidden', 'id', Input::old('id'), array('class'=>'form-control')) }}
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                          {{ Form::text('geo_lat', Input::old('geo_lat'), array('class'=>'form-control')) }}
                        </div>
                        {{ Form::label('geo_long', 'Longituda:', array('class'=>'col-md-2 control-label')) }}
                        <div class="col-sm-4">
                          {{ Form::text('geo_long', Input::old('geo_long'), array('class'=>'form-control')) }}
                        </div>
                    </div>
                    <br>
                    <div class="row">
        ...
        <div class="form-group text-center">
            <div class="col-sm-12">
              ...
              {{ link_to_route('institutions.index', 'Odustani', $institution->id, array('class' => 'btn btn-lg btn-default')) }}
            </div>
        </div>
